...
<script>
import { LINE, CIRCLE, PATH, SEMICIRCLE } from './constants'
import { extend } from './utils'
import { Circle, Line, Path, SemiCircle } from 'progressbar.js'
  ...
  props: {
    type: {
      ...
      validator: function (val) {
        return val === LINE || val === CIRCLE || val === PATH || val === SEMICIRCLE
      }
    },
    color: {
      type: String,
    ...
    init () {
      ...
      switch (this.type) {
        case CIRCLE:
          ...
          break
        case SEMICIRCLE:
          this.progress = new SemiCircle(this.$el, options)
          break
        case PATH:
