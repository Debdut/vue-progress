<template>
  <div class="wrap">
    ...
    <div class="container">
      ...
      <h2 class="text-left">semicircle</h2>

      <!-- Basic SemiCircle -->
      <card>
        <div slot="content">
          <progress-bar class="semicircle" ref="basicSemiCircle" type="semicircle" :options="semiCircleBasicOptions"></progress-bar>
        </div>
        <div slot="footer">
          basic semi circle
        </div>
      ...
      <card>
        <div slot="content">
          <progress-bar class="semicircle" ref="bounceSemiCircle" type="semicircle" :options="semiCircleBounceOptions"></progress-bar>
        </div>
        <div slot="footer">
          basic semi circle
        </div>
      ...
      <card>
        <div slot="content">
          <progress-bar class="semicircle" ref="percentSemiCircle" type="semicircle" :options="semiCirclePercentOptions"></progress-bar>
        </div>
        <div slot="footer">
          percent semi circle
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      semiCircleBasicOptions: OPTIONS.SEMICIRCLE_BASIC,
      semiCircleBounceOptions: OPTIONS.SEMICIRCLE_BOUNCE,
      semiCirclePercentOptions: OPTIONS.SEMICIRCLE_PERCENT,   
  ...
  methods: {
    init () {
      ...
      let basicSemiCircle = this.$refs.basicSemiCircle
      loopAnimate(basicSemiCircle)
      let bounceSemiCircle = this.$refs.bounceSemiCircle
      loopAnimate(bounceSemiCircle)
      let percentSemiCircle = this.$refs.percentSemiCircle
      loopAnimate(percentSemiCircle)
